...
class MyContract extends Contract {
    ...
    async init(ctx) {
        ...
        let car2 = await new Car('CAR2', 'Ford',       'white', 'Kandal 2AB-1231',     'Kok Sva');
        let car3 = await new Car('CAR3', 'Toyota',     'white', 'Phnom Penh 2AQ-3246', 'Kok Kdam');
        let car4 = await new Car('CAR4', 'Rang Rover', 'white', 'Phnom Penh 2N-3987',  'Kok Jma');
